...
// const DefaultABC = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ"
...
// GenerateShortID generates an Id using the default generator.
...
// GenerateShortID generates an Id using the default generator and return error.
func GenerateShortIDWithErr() (string, error) {
	return shortid.Generate()
}

// GenerateShortIDWithPanic acts just like GenerateShortID, but panics instead of returning errors.
func GenerateShortIDWithPanic() string {
	id, err := shortid.Generate()
	if err == nil {
		return id
	}
